...
if __name__ == '__main__':
    ...
    u.get(u.create_parameter('test', 'truck.appapi.createPreorder','username=李四,mobile=13730645598,identitycard=222403198503305018,address=成都市成华区,number=5,type=1', ''))
