...
if __name__ == '__main__':
    ...
    u.get(u.create_parameter('test', 'truck.appapi.terminateProtocol','type=1,password=DADFAD23434545679FVKJHK,captcha=293847,bankAcNo=6225882722934231', 'smart040'))
