...
if __name__ == '__main__':
    ...
    u.get(u.create_parameter('test', 'truck.score.bindCard','unionid=oTBn-jt2RQSHdBoJQYFSdnZo8BBQ,truename=李四,tel=13730645598,sex=1,birthday=2000-01-01', 'smart040'))
